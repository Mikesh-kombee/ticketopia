...
const IssueCategorizationInputSchema = z.object({
  notes: z
    .string()
    .describe("The notes provided in the ticket describing the issue."),
});
export type IssueCategorizationInput = z.infer<
  typeof IssueCategorizationInputSchema
>;
...
export type IssueCategorizationOutput = z.infer<
  typeof IssueCategorizationOutputSchema
>;

export async function categorizeIssue(
  input: IssueCategorizationInput
): Promise<IssueCategorizationOutput> {
