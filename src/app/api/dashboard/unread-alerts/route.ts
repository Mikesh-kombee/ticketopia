...
import type { DashboardAlertSummary, AlertType, AlertSeverity, AlertStatus } from '@/lib/types';
...
const mockUnreadAlerts: DashboardAlertSummary[] = Array.from({ length: 8 }, (_, i) => {
